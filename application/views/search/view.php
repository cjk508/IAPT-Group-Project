...
<div class="panel panel-default  category-box pull-right">
	...
	<div class="panel-body">
		...
		<ul class="media-list">
<?php
// If there are no search terms in the results then don't attempt to display anything from the array as it is empty
 if(is_null($searchValues) == TRUE){
			...
			<li
				...
				href="<?php echo site_url('recipe/'.$searchValue->getID()); ?>"> <img
					...
					alt="<?php echo $searchValue->getImageAlt(); ?>">
