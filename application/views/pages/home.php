		...
		<div class = "otherFour pull-right">
			...
			<div class = "topRight pull-right">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[2]->getID()); ?>"> 
					<img style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[2]->getImage();?>" alt="...">
					<h4>
			...
			<div class = "bottomLeft pull-left">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[3]->getID()); ?>"> 
					<img style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[3]->getImage();?>" alt="...">
					<h4>
			...
			<div class = "bottomRight pull-right">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[4]->getID()); ?>"> 
					<img style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[4]->getImage();?>" alt="...">
					<h4>
