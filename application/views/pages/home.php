	...
	<div class = "panel-body">
		<div class = "featuredRecipe pull-left">
			<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[0]->getID()); ?>"> 
				<img  class = "thumbnail" src="<?php echo base_url('assets/images/')."/".$mostRecents[0]->getImage();?>" alt="...">
				<h4>
		...
		<div class = "otherFour pull-right">
			<div class = "topLeft pull-left">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[1]->getID()); ?>"> 
					<img class = "thumbnail" style="height:auto; width:100%" src="<?php echo base_url('assets/images/')."/".$mostRecents[1]->getImage();?>" alt="...">
					<h4>
			...
			<div class = "topRight pull-right">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[2]->getID()); ?>"> 
					<img class = "thumbnail" style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[2]->getImage();?>" alt="...">
					<h4>
			...
			<div class = "bottomLeft pull-left">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[3]->getID()); ?>"> 
					<img class = "thumbnail" style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[3]->getImage();?>" alt="...">
					<h4>
			...
			<div class = "bottomRight pull-right">
				<a class="pull-left" href="<?php echo site_url('recipe/'.$mostRecents[4]->getID()); ?>"> 
					<img class = "thumbnail" style="height:auto; width:100%; overflow-x:hidden;" src="<?php echo base_url('assets/images/')."/".$mostRecents[4]->getImage();?>" alt="...">
					<h4>
